...
AWSES.prototype._request = function(path, body, options, callback) {
    ...
    var req = https.request(opts, function(res) {
        ...
        res.on('end', function() {
            try {
                return callback(null, JSON.parse(fullResponse), res.statusCode);
            } catch (e) {
...
AWSES.prototype.search = function(options, callback) {
    ...
    if (options.ignoreUnavailable) qs.ignore_unavailable = options.ignoreUnavailable;
...
AWSES.prototype.indexExists = function(options, callback) {
    ...
    var path = '/' + options.index;
    this._request(path, null, {method: 'HEAD'}, function(err, data, statusCode) {
        ...
        callback(error, exists, statusCode);
    });
};
